...
<template>
  <div class="logicflow-pattern" id="logicflowPattern" ref="logicflowPattern">
    <div class="pattern-selection" @click="openSelection" />
    <div>选区</div>
    <div class="pattern-start" @click="addStartNode" />
    <div>开始</div>
    <div class="pattern-user" @click="addUserTask"></div>
    <div>用户任务</div>
    <div class="pattern-user" @click="addServiceTask"></div>
    <div>系统任务</div>
    <div class="pattern-condition" @click="addGateWay"></div>
    <div>条件判断</div>
    <div class="pattern-end" @click="addEndNode"></div>
    <div>结束</div>
  </div>
</template>
